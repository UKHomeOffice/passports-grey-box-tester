...
class WebDriver {
    ...
    async setElementValue(selector, value, selectBox) {
        ...
        if (typeof value === 'boolean') {
            ...
            if (inputType === 'file') {
                debug('Setting element', selector, inputType, value);
                await element.sendKeys(value);
            } else {
                debug('Clearing and setting element', selector, inputType, value);
                await element.sendKeys(Key.HOME, Key.chord(Key.SHIFT, Key.END), value);
            }
        }
    }
